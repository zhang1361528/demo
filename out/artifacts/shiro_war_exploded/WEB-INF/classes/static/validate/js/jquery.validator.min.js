...
!function (e) {
    ...
    function i(t, n) {
        function s() {
            a.$el = e(t), a.$el.length ? a._init(a.$el[0], n) : W(t) && (z[t] = n)
        }
    ...
    function n(t) {
        function i() {
            var t = this.options;
            for (var i in t) i in K && (this[i] = t[i]);
            e.extend(this, {
                _valHook: function () {
    ...
    function u(e, t, i) {
        var n = t.msg, s = t._r;
        return J(n) && (n = n[s]), W(n) || (n = X(e, V + "-" + s) || X(e, V) || (i ? W(i) ? i : i[s] : "")), n
    }

    function d(e) {
        var t;
        return e && (t = D.exec(e)), t && t[0]
    }
    ...
    var h, p = "validator", v = "." + p, _ = ".rule", y = ".field", b = ".form", k = "nice-" + p, w = "msg-box",
        x = "aria-invalid", M = "data-rule", V = "data-msg", O = "data-tip", F = "data-ok", $ = "data-timely",
        E = "data-target", C = "data-display", A = "data-must", j = "novalidate", N = ":verifiable",
        T = /(&)?(!)?\b(\w+)(?:\[\s*(.*?\]?)\s*\]|\(\s*(.*?\)?)\s*\))?\s*(;|\|)?/g,
        S = /(\w+)(?:\[\s*(.*?\]?)\s*\]|\(\s*(.*?\)?)\s*\))?/, R = /(?:([^:;\(\[]*):)?(.*)/, q = /[^\x00-\xff]/g,
        D = /top|right|bottom|left/, I = /(?:(cors|jsonp):)?(?:(post|get):)?(.+)/i,
        H = /[<>'"`\\]|&#x?\d+[A-F]?;?|%3[A-F]/gim, L = e.noop, B = e.proxy, P = e.trim, U = e.isFunction,
        W = function (e) {
            return "string" == typeof e
        }, J = function (e) {
            return e && "[object Object]" === Object.prototype.toString.call(e)
        }, Q = document.documentMode || +(navigator.userAgent.match(/MSIE (\d+)/) && RegExp.$1), X = function (e, i, n) {
            ...
            dataFilter: function (e) {
                if (W(e) || J(e) && ("error" in e || "ok" in e)) return e
            },
            msgMaker: function (t) {
                var i;
    ...
    return e.fn.validator = function (t) {
        ...
        var n, s, a = l(this[0]), r = U(e);
        return !a || (r || i !== t || (i = e), a.checkOnly = !!i, s = a.options, n = a._multiValidate(this.is(N) ? this : this.find(N), function (t) {
            t || !s.focusInvalid || a.checkOnly || a.$el.find("[" + x + "]:first").focus(), r && (e.length ? e(t) : t && e()), a.checkOnly = !1
        }), r ? this : n)
        ...
        _init: function (t, i) {
            ...
            function t(e, t) {
                ...
                } else a.fields[e] = new a.Field(e, W(t) ? {rule: t} : t, a.fields[e])
            }

            var i, n, s, a = this, r = null === e;
            if (r && (e = a.fields), J(e)) for (i in e) if (~i.indexOf(",")) for (n = i.split(","), s = n.length; s--;) t(P(n[s]), e[i]); else t(i, e[i]);
            a.$el.find(N).each(function () {
                a._parse(this)
            })
        }, _parse: function (e) {
            var t, i, n, s = this, a = e.name, r = X(e, M);
            return r && X(e, M, null), e.id && ("#" + e.id in s.fields || !a || null !== r && (t = s.fields[a]) && r !== t.rule && e.id !== t.key) && (a = "#" + e.id), a || (a = "#" + (e.id = "N" + String(Math.random()).slice(-12))), t = s.getField(a, !0), t.rule = r || t.rule, (i = X(e, C)) && (t.display = i), t.rule && ((null !== X(e, A) || /\b(?:match|checked)\b/.test(t.rule)) && (t.must = !0), /\brequired\b/.test(t.rule) && (t.required = !0), (n = X(e, $)) ? t.timely = +n : t.timely > 3 && X(e, $, t.timely), s._parseRule(t), t.old = {}), W(t.target) && X(e, E, t.target), W(t.tip) && X(e, O, t.tip), s.fields[a] = t
        }, _parseRule: function (i) {
            var n = R.exec(i.rule);
            n && (i._i = 0, n[1] && (i.display = n[1]), n[2] && (i._rules = [], n[2].replace(T, function () {
                var n = arguments;
                n[4] = n[4] || n[5], i._rules.push({
                    ...
                    or: "|" === n[6],
                    method: n[3],
                    params: n[4] ? e.map(n[4].split(", "), P) : t
                })
            })))
            ...
            var n = this, s = n.options, a = i.target,
                r = "submit" === i.type && "FORM" === a.tagName && !i.isDefaultPrevented();
            i.preventDefault(), h && ~(h = !1) || n.submiting || "validate" === i.type && n.$el[0] !== a || U(s.beforeSubmit) && s.beforeSubmit.call(n, a) === !1 || (n.isAjaxSubmit === t && n._guessAjax(a), n._debug("log", "\n<<< event: " + i.type), n._reset(), n.submiting = !0, n._multiValidate(n.$el.find(N), function (t) {
                var i, l = t || 2 === s.debug ? "valid" : "invalid";
                t || (s.focusInvalid && n.$el.find("[" + x + "]:first").focus(), i = e.map(n.errors, function (e) {
                    return e
                })), n.submiting = !1, n.isValid = t, U(s[l]) && s[l].call(n, a, i), n.$el.trigger(l + b, [a, i]), n._debug("log", ">>> " + l), t && (n.vetoed ? e(a).ajaxSubmit(n.ajaxFormOptions) : r && !n.isAjaxSubmit && document.createElement("form").submit.call(a))
            }))
        }, _reset: function (e) {
            var t = this;
            ...
            n.validating || "click" === e.type && document.activeElement === a || (s.focusCleanup && "true" === X(a, x) && (n._setClass(a, null), n.hideMsg(a)), i = X(a, O), i ? n.showMsg(a, {
                type: "tip",
                msg: i
            }) : (X(a, M) && n._parse(a), (t = X(a, $)) && (8 !== t && 9 !== t || n._focusout(e))))
        }, _focusout: function (t) {
            var i, n, s, a, r, l, o, u, d, f = this, g = f.options, m = t.target, h = t.type, p = "focusin" === h,
                v = "validate" === h, _ = 0;
            if ("compositionstart" === h && (f.pauseValidate = !0), "compositionend" === h && (f.pauseValidate = !1), !f.pauseValidate && (n = m.name && c(m) ? f.$el.find('input[name="' + m.name + '"]').get(0) : m, (s = f.getField(n)) && s.rule)) {
                if (i = s._e, s._e = h, d = s.timely, !v) {
                    ...
                    if ("focusout" === h) {
                        if ("change" === i) return;
                        if (2 === d || 8 === d) {
                            if (a = s.old, !r || !a) return;
                            s.isValid && !a.showOk ? f.hideMsg(m) : f._makeMsg(m, s, a)
                        }
                    } else {
            ...
            var n = this, s = e.target;
            n.$el.is(s) ? J(t) ? n.showMsg(t) : "tip" === t && n.$el.find(N + "[" + O + "]", s).each(function () {
                n.showMsg(this, {type: t, msg: i})
            }) : n.showMsg(s, {type: t, msg: i})
        }, _hidemsg: function (t) {
            var i = e(t.target);
            ...
            var r, l, o, d, c = this, f = n._r, g = n.timely, m = 9 === g || 8 === g, h = !1;
            if (null === s) return c._validatedField(i, n, {isValid: !0, skip: !0}), void (n._i = 0);
            if (s === t ? o = !0 : s === !0 || "" === s ? h = !0 : W(s) ? r = s : J(s) ? s.error ? r = s.error : (r = s.ok, h = !0) : h = !!s, l = n._rules[n._i], l.not && (r = t, h = "required" === f || !h), l.or) if (h) for (; n._i < n._rules.length && n._rules[n._i].or;) n._i++; else o = !0; else l.and && (n.isValid || (o = !0));
            o ? h = !0 : (h && n.showOk !== !1 && (d = X(i, F), r = null === d ? W(n.ok) ? n.ok : r : d, !W(r) && W(n.showOk) && (r = n.showOk), W(r) && (a.showOk = h)), h && !m || (r = (u(i, n, r || l.msg || c.messages[f]) || c.messages.fallback).replace(/\{0\|?([^\}]*)\}/, function (e, t) {
                return c._getDisplay(i, n.display) || t || c.messages[0]
            })), h || (n.isValid = h), a.msg = r, e(i).trigger((h ? "valid" : "invalid") + _, [f, r])), !m || o && !l.and || (h || n._m || (n._m = r), n._v = n._v || [], n._v.push({
                type: h ? o ? "tip" : "ok" : "error",
                msg: r || l.msg
            })), c._debug("log", "   " + n._i + ": " + f + " => " + (h || r)), (h || m) && n._i < n._rules.length - 1 ? (n._i++, c._checkRule(i, n)) : (n._i = 0, m ? (a.isValid = n.isValid, a.result = n._v, a.msg = n._m || "", n.value || "focusin" !== n._e || (a.type = "tip")) : a.isValid = h, c._validatedField(i, n, a), delete n._m, delete n._v)
        }, _checkRule: function (i, n) {
            var s, a, r, l = this, u = n.key, d = n._rules[n._i], c = d.method, f = d.params;
            l.submiting && l.deferred[u] || (r = n.old, n._r = c, r && !n.must && !d.must && d.result !== t && r.ruleName === c && r.id === i.id && n.value && r.value === n.value ? s = d.result : (a = o(i, c) || l.rules[c] || L, s = a.call(n, i, f, n), a.msg && (d.msg = a.msg)), J(s) && U(s.then) ? (l.deferred[u] = s, n.isValid = t, !l.checkOnly && l.showMsg(i, {
                type: "loading",
                msg: l.messages.loading
            }, n), s.then(function (s, a, r) {
                var o, u = P(r.responseText), c = n.dataFilter;
            ...
            var i = this;
            if (!e.disabled && null === X(e, j) && (t = t || i.getField(e), t && (t._rules || i._parse(e), t._rules))) return i._debug("info", t.key), t.isValid = !0, t.element = e, t.value = t.getValue(), t.required || t.must || t.value || c(e) ? (i._checkRule(e, t), t.isValid) : (i._validatedField(e, t, {isValid: !0}), !0)
        }, _debug: function (e, t) {
            window.console && this.options.debug && console[e](t)
        }, test: function (e, i) {
            var n, s, a, r, l = this, o = S.exec(i);
            ...
            return W(t) ? t : U(t) ? t.call(this, e) : ""
            ...
            var s, a, r, l, o = e(i);
            if (o.is(N) ? (r = n.target || X(i, E), r && (r = U(r) ? r.call(this, i) : "#" === r.charAt(0) ? e(r) : this.$el.find(r), r.length && (r.is(N) ? (o = r, i = r.get(0)) : r.hasClass(w) ? s = r : l = r)), s || (a = c(i) && i.name || !i.id ? i.name : i.id, s = (l || this.$el).find(n.wrapper + "." + w + '[for="' + a + '"]'))) : s = o, !n.hide && !s.length) if (s = e("<" + n.wrapper + ">").attr({
                "class": w + (n.cls ? " " + n.cls : ""),
                style: n.style || t,
                "for": a
            }), l) s.appendTo(l); else if (c(i)) {
                var u = o.parent();
                s.appendTo(u.is("label") ? u.parent() : u)
            } else s[n.pos && "right" !== n.pos ? "insertBefore" : "insertAfter"](o);
            return s
        }, showMsg: function (t, i, n) {
            if (t) {
                var s, a, r, l, o = this, u = o.options;
                if (J(t) && !t.jquery && !i) return void e.each(t, function (e, t) {
                    var i = o.elements[e] || o.$el.find(m(e))[0];
                    o.showMsg(i, t)
                });
                e(t).is(N) && (n = n || o.getField(t)), (a = (n || u).msgMaker) && (i = o._getMsgOpt(i, n), t = (t.name && c(t) ? o.$el.find('input[name="' + t.name + '"]') : e(t)).get(0), i.msg || "error" === i.type || (r = X(t, "data-" + i.type), null !== r && (i.msg = r)), W(i.msg) && (l = o._getMsgDOM(t, i), !D.test(l[0].className) && l.addClass(i.cls), 6 === Q && "bottom" === i.pos && (l[0].style.marginTop = e(t).outerHeight() + "px"), l.html(a.call(o, i))[0].style.display = "", U(s = n && n.msgShow || u.msgShow) && s.call(o, l, i.type)))
            }
        }, hideMsg: function (t, i, n) {
            var s, a, r = this, l = r.options;
            t = e(t).get(0), e(t).is(N) && (n = n || r.getField(t), n && (n.isValid || r.reseting) && X(t, x, null)), i = r._getMsgOpt(i, n), i.hide = !0, a = r._getMsgDOM(t, i), a.length && (U(s = n && n.msgHide || l.msgHide) ? s.call(r, a, i.type) : (a[0].style.display = "none", a[0].innerHTML = ""))
        }, getField: function (e, i) {
            var n, s, a = this;
            if (W(e)) n = e, e = t; else {
                if (X(e, M)) return a._parse(e);
                n = e.id && "#" + e.id in a.fields || !e.name ? "#" + e.id : e.name
            }
            return ((s = a.fields[n]) || i && (s = new a.Field(n))) && (s.element = e), s
        }, setField: function (e, t) {
            var i = {};
            e && (W(e) ? i[e] = t : i = e, this._initFields(i))
            ...
            this._reset(1), this.$el.off(v).removeData(p), X(this.$el[0], j, this._NOVALIDATE)
        }
    }, e(window).on("beforeunload", function () {
        this.focus()
    }), e(document).on("click", ":submit", function () {
        var e, t = this;
        t.form && (e = t.getAttributeNode("formnovalidate"), (e && null !== e.nodeValue || null !== X(t, j)) && (h = !0))
    }).on("focusin submit validate", "form,." + k, function (t) {
        if (null === X(this, j)) {
            var i, n = e(this);
            !n.data(p) && (i = l(this)) && (e.isEmptyObject(i.fields) ? (X(this, j, j), n.off(v).removeData(p)) : "focusin" === t.type ? i._focusin(t) : i._submit(t))
        }
    }), new a({fallback: "This field is not valid.", loading: "Validating..."}), new s({
        required: function (t, i) {
            var n = this, s = P(n.value), a = !0;
            if (i) if (1 === i.length) {
                if (g(i[0])) {
                    if (n.rules[i[0]] && !s && !n.test(t, i[0])) return null
            ...
            if (i) {
                var n, s, a, r, l, o, u, d = this, c = !0, g = "eq";
                if (1 === i.length ? a = i[0] : (g = i[0], a = i[1]), l = m(a), o = d.$el.find(l)[0]) {
                    if (u = d.getField(o), n = d.value, s = u.getValue(), d._match || (d.$el.on("valid" + y + v, l, function () {
                        e(t).trigger("validate")
                    }), d._match = u._match = 1), !d.required && "" === n && "" === s) return null;
                    if (r = i[2], r && (/^date(time)?$/i.test(r) ? (n = f(n), s = f(s)) : "time" === r && (n = +n.replace(/:/g, ""), s = +s.replace(/:/g, ""))), "eq" !== g && !isNaN(+n) && isNaN(+s)) return !0;
                    switch (g) {
                        case"lt":
                            c = +n < +s;
                            break;
                    ...
                    return c || J(d.messages.match) && d.messages.match[g].replace("{1}", d._getDisplay(o, u.display || a))
                }
            }
        }, range: function (e, t) {
            ...
            if (c(e)) {
                ...
                }).length : (i = e, n = i.checked), t ? s.getRangeMsg(n, t) : !!n || u(i, s, "") || s.messages.required || !1
            }
        }, length: function (e, t) {
            var i = this.value, n = ("true" === t[1] ? i.replace(q, "xx") : i).length;
            return this.getRangeMsg(n, t, t[1] ? "_2" : "")
        }, remote: function (t, i) {
            if (i) {
                var n, s = this, a = I.exec(i[0]), r = s._rules[s._i], l = {}, o = "", u = a[3], d = a[2] || "POST",
                    c = (a[1] || "").toLowerCase();
                return r.must = !0, l[t.name] = s.value, i[1] && e.map(i.slice(1), function (e) {
                    var t, i;
                    ~e.indexOf("=") ? o += "&" + e : (t = e.split(":"), e = P(t[0]), i = P(t[1]) || e, l[e] = s.$el.find(m(i)).val())
            ...
            var i = this.value, n = i.replace(t ? new RegExp("[" + t[0] + "]", "gm") : H, "");
            n !== i && this.setValue(n)
        }
    }), i.config = function (t, i) {
        function n(e, t) {
            "rules" === e ? new s(t) : "messages" === e ? new a(t) : e in K ? K[e] = t : G[e] = t
        }

        J(t) ? e.each(t, n) : W(t) && n(t, i)
    }, i.setTheme = function (t, i) {
        J(t) ? e.extend(!0, Y, t) : W(t) && J(i) && (Y[t] = e.extend(Y[t], i))
    }, i.load = function (t) {
        if (t) {
            var n, s, a, r = document, l = {}, o = r.scripts[0];
            t.replace(/([^?=&]+)=([^&#]*)/g, function (e, t, i) {
                l[t] = i
            }), n = l.dir || i.dir, i.css || "" === l.css || (s = r.createElement("link"), s.rel = "stylesheet", s.href = i.css = n + "jquery.validator.css", o.parentNode.insertBefore(s, o)), !i.local && ~t.indexOf("local") && "" !== l.local && (i.local = (l.local || r.documentElement.lang || "en").replace("_", "-"), i.pending = 1, s = r.createElement("script"), s.src = n + "local/" + i.local + ".js", a = "onload" in s ? "onload" : "onreadystatechange", s[a] = function () {
